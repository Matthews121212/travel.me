    ...
    <body>
        ...
        <header class="py-5 bg-image-full header">
            ...
            <div class="text-center my-2 justify-content-center text-white">
                    <div class="container">
                        <form class="d-inline-flex mx-1" role="search" action="" id="myForm" method="POST">
                            ...
                            <button class="btn-primary btn mx-1" onclick="setAction('search.php')" type="submit">Search</button>
                            <button class="btn-primary btn mx-1" onclick="setAction('generatetravel.php')" type="submit">Generate</button>
                        </form>
                    </div>
            </div>
        </header>
